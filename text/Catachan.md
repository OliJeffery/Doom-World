...
Much of a Catachan Jungle Fighter's life is spent in the deep jungle, on missions that take them into the heart of the Death World itself, into places where the darkness runs deep and the horrors that should not exist lurk in every shadow. It is commonplace to awaken from a short and fitful rest still deep in hostile territory, surrounded by things that want you dead, your life hanging by a thread, your faith in the Emperor the only thing standing between you and the endless darkness. When the time comes to emerge from these places—whether mission complete or beaten and bloody—a Catachan seeks out safety and resupply, a moment's respite from the endless horror.

These are the comforts of base: a hot meal, a clean bunk, the company of fellow Catachans who understand the perpetual conflict. Often thoughts of returning to these places are all that keep a soldier going when the jungle is trying to kill them, when the darkness closes in and all hope seems lost. All fight for the Emperor and duty, but who does not ache for a place to rest, to repair gear, to share stories around a fire about the things you have survived, the horrors you have faced, the deaths you have cheated?

This chapter covers the wider world of Catachan—the military bases, outposts, and settlements where Catachan Jungle Fighters can find safety, resupply, and brief respite from the constant danger. The always marching movement of the GM's fronts will shape the world and, in turn, the world reflects the actions the players take to complete missions and survive, for on Catachan, even safety is relative, and the darkness never truly relents.

### Bases and Outposts

We call all the assorted military installations, outposts, and settlements where there is a place to stay and some modicum of safety**bases**, as in "forward operating base." Bases are places with at least a handful of inhabitants, always humans, and some stable structures, fortifications that stand against the endless hunger of the jungle. They can be as big as a major military installation or as small as a few prefab buildings surrounded by razor wire, but all share one thing in common: they are islands of relative safety in an ocean of endless horror, places where the darkness is held at bay, for now.

## Creating the World

Remember how you started the first session? With action either underway or impending? At some point the characters are going to need to retreat from that action, either to heal their wounds or to report in and resupply.

When the players leave the site of their first mission for the safety of a base it's time to start drawing the campaign map. Take a large sheet of paper (plain white if you like or hex-gridded if you want to get fancy), place it where everyone can see, and make a mark for the site of the mission. Use pencil: this map will change. It can be to-scale and detailed or broad and abstract, depending on your preference, just make it obvious. Keep the mark small and somewhere around the center of the paper so you have space to grow.

Now add the nearest base, a place the characters can go to rest and gather supplies. Draw a mark for that place on the map and fill in the space between with some terrain features. Try to keep it within a day or two of the site of their first mission—a short trip through dense jungle or across dangerous swampland is suitable, or a wider distance by cleared path or through hostile territory.

When you have time (after the first session or during a snack break, for example) use the rules to create the first base. Consider adding marks for other places that have been mentioned so far, either details from character creation or the base rules themselves.

## While You're At Base…

When the players visit a base there are some special moves they'll be able to make. These still follow the fictional flow of the game. When the players arrive, ask them "What do you do?" The players' actions will, more often than not, trigger a move from this list. They cover respite, reinvigoration, and resupply—opportunities for the players to gather their wits and restock their gear. Remember that a base isn't a break from reality. You're still making hard moves when necessary and thinking about how the players' actions (or inaction) advances your fronts. The impending doom is always there, whether the players are fighting it in the jungle or ignoring it while getting drunk in the mess hall.

Don't let a visit to a base become a permanent respite. Remember, Catachan is a Death World. If the players choose to ignore that, they're giving you a golden opportunity to make a hard move. Fill the characters' lives with danger whether they're out seeking it or not. These moves exist so you can make a visit to base an interesting event without spending a whole session haggling over the cost of new ammo.

## Elements of a Base

A base is any military installation or settlement that offers some amount of safety to its inhabitants. Outposts, forward bases, and major installations are the most common bases. Bases are described by their tags. All bases have tags indicating supplies, personnel, and defenses. Many will have tags to illustrate their more unusual properties.

Bases are differentiated based on size. The size indicates roughly how many people the base can support. The personnel tag tells you if the current population is more than or less than this amount.

Outposts are the smallest bases. They're usually remote, deep in hostile territory. If they're lucky they can muster some defense but it's often just a few guards with lasguns and basic fortifications. An outpost stands near some strategically important location: a river crossing, a high point for observation, or a resource extraction site. There might be basic supplies available but more likely they rely on resupply from larger bases. Equipment is scarce.

Forward bases have a hundred or so personnel. They're the kind of place that springs up around a strategic location, supply depot, or command post and usually have barracks, mess halls, and basic facilities. They might have a standing guard force of soldiers ready to defend the base. Forward bases have the basics for resupply but certainly no special equipment. Usually they'll focus on a specific mission type or two and support operations in their area.

A fortified base is built specifically for defense—sometimes of a particularly important location like a major supply depot or command center. Fortified bases are found at the edges of controlled territory. Personnel are inured to the day-to-day dangers of the jungle. They're tough soldiers that number between a hundred and a thousand, depending on the size of the base and the place it defends. Fortified bases won't often have much beyond their own supplies, resupplied from larger installations, but will almost always have heavy weapons and sometimes rare equipment found in the local area.

From major command center to sprawling military installation, the major base represents the largest sort of base on Catachan. These are places where soldiers of many regiments and specializations can be found. They often exist at the confluence of supply routes or are built in a place of strategic significance. They don't often generate their own raw materials, relying on supplies from smaller bases for food and resources, but will always have equipment and some specialized gear for sale to those with the proper authorization.

Supplies indicate what kinds of items are usually available. Personnel indicates the number of inhabitants relative to the current size of the base. Defenses indicate the general scope of arms the base has. Tags in these categories can be adjusted. -Category means to change the base to the next lower tag for that category (so Moderate would become Poor with -Supplies). +Category means to change the base to the next higher tag (so Shrinking becomes Steady with +Personnel). Tags in those categories can also be compared like numbers. Treat the lowest tag in that category as 1 and each successive tag as the next number (so Dirt is 1, Poor is 2, etc.).

Tags will change over the course of play. Creating a base provides a snapshot of what that place looks like*right now*. As the players spend time in it and your fronts progress the world will change and your bases with it.
